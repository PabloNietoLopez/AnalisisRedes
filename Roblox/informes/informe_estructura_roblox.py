...
def informe_nodos_aristas(diccionario):
...
El número total de nodos en la red es: {num_nodos}

El número total de enlaces en la red es: {num_aristas}

Estos resultados permiten tener una idea general de la cantidad de información que se maneja en la red. Además, se muestra una gran cantidad de relaciones en relación al número de nodos, lo que sugiere una red densa y altamente conectada: {ratio} enlaces por nodo en promedio.

"""
    return template_resultados.format(
        num_nodos=diccionario.get("num_nodos"),
        num_aristas=diccionario.get("num_aristas"),
        ratio=diccionario.get("num_aristas") / diccionario.get("num_nodos"),
    )


def informe_grados_clustering(diccionario):
    template_resultados = r"""
\clearpage
...
![Gráfica de la distribucion de grados]({distribucion_grados})
\clearpage
...
![Gráfica de la distribucion de clustering]({distribucion_clustering})
...
"""
    return template_resultados.format(
        distribucion_grados=diccionario.get("distribucion_grados"),
        distribucion_clustering=diccionario.get("distribucion_clustering"),
    )


def informe_grados_clustering_hubs(diccionario):
    template_resultados = r"""
\clearpage
...
![Gráfica de la distribucion de grados]({distribucion_grados_hubs})
![Gráfica de la distribucion de coeficientes de Clustering]({distribucion_clustering_hubs})
...
"""
    return template_resultados.format(
        distribucion_grados_hubs=diccionario.get("distribucion_grados_hubs"),
        distribucion_clustering_hubs=diccionario.get("distribucion_clustering_hubs"),
    )


def informe_cnj_grados_clustering(diccionario):
    template_resultados = r"""
\clearpage
## Distribución conjunta de grados y coeficientes de Clustering

![Distribución conjunta de grados y coeficientes de Clustering]({cnj_grados_clustering})
...
"""
    return template_resultados.format(
        cnj_grados_clustering=diccionario.get("cnj_grados_clustering")
    )


def informe_visualizacion(diccionario):
    template_resultados = r"""
\clearpage
...
![Visualización del grafo]({visualizacion_grafo})
...
"""
    return template_resultados.format(
        visualizacion_grafo=diccionario.get("visualizacion_grafo")
    )


def informe_media_distancia(diccionario):
    template_resultados = r"""
\clearpage
## Distancia media
...
La distancia media entre los nodos de la red es: {media_distancia}.
...
"""
    return template_resultados.format(
        media_distancia=diccionario.get("distancia_media"),
    )


def informe_diametro(diccionario):
    template_resultados = r"""
## Diámetro
...
El diámetro de esta red es: {diametro}.
...
"""
    return template_resultados.format(
        diametro=diccionario.get("diametro"),
    )


def informe_distribucion_distancias(diccionario):
    template_resultados = r"""
\clearpage
...
![Distribución de distancias desde los hub]({distribucion_distancias})
...
"""
    return template_resultados.format(
        distribucion_distancias=diccionario.get("distribucion_distancias"),
    )


def informe_probabilidad(diccionario):
    # Crear el template con los resultados dinámicos de esperanza, varianza y probabilidad de enlace
...
La **probabilidad de enlace** de esta red es: {probabilidad:.5f}.

La **esperanza** de esta red es: {esperanza}.

La **varianza** de esta red es: {varianza}.
...
"""
    return template_probabilidad.format(
        esperanza=diccionario.get("esperanza"),
        varianza=diccionario.get("varianza"),
        probabilidad=diccionario.get("probabilidad"),
    )


def conclusiones():
    # Crear el template con las conclusiones finales del análisis de estructura
    template_probabilidad = r"""
\clearpage
## Conclusiones
...
def generar_resultados(diccionario):
    ...
    # Grafo
    informes.append(informe_nodos_aristas(diccionario))

    # Grados y clustering
    informes.append(informe_grados_clustering(diccionario))
    informes.append(informe_grados_clustering_hubs(diccionario))
    informes.append(informe_cnj_grados_clustering(diccionario))
    informes.append(informe_visualizacion(diccionario))

    # Distancias
    informes.append(informe_media_distancia(diccionario))
    informes.append(informe_diametro(diccionario))
    informes.append(informe_distribucion_distancias(diccionario))

    # Probabilidad
    informes.append(informe_probabilidad(diccionario))

    # Conclusiones
    informes.append(conclusiones())

    # Combinar todos los informes en el orden en que fueron agregados
    informe_completo = "\n".join(informes)

    # Obtener la hora actual y formatearla para el nombre del archivo
    ahora = datetime.datetime.now()
    fecha_hora = ahora.strftime(
        "%d-%m-%Y_%H-%M"
    )  # Formato adecuado para nombres de archivo

    nombre_archivo = f"informe_roblox_estructura{fecha_hora}.md"
